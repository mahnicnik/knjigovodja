 ...
 *
 * Vsebina se je preselila v components/nastavitve/EmailSkeniranje.tsx in se prikazuje ZNOTRAJ /nastavitve —
...
export default function Preusmeritev() {
  ...
  useEffect(() => { router.replace('/nastavitve?razdelek=email') }, [router])
  return (
