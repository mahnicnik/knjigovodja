 ...
 *
 * Vsebina se je preselila v components/nastavitve/Blagajna.tsx in se prikazuje ZNOTRAJ /nastavitve —
...
export default function Preusmeritev() {
  ...
  useEffect(() => { router.replace('/nastavitve?razdelek=blagajna') }, [router])
  return (
