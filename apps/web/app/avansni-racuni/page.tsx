            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
                <div>
                  ...
                  <input type="number" onFocus={e => e.target.select()} step="0.01" value={totalAmount || ''} onChange={e => setTotalAmount(e.target.value === '' ? 0 : Number(e.target.value))} placeholder="0.00" style={inp} />
                </div>
                <div>
