...
// MAIN PAGE
// ================================================================
export default function BlagajnaSekcija() {
  ...
  return (
    <div style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>
      ...
      <div style={{ marginBottom: 32 }}>
        {/* Enotna glava razdelka (19.8.2026) — ista velikost in slog kot
            ostali razdelki nastavitev. */}
        <div style={{ fontSize: 15, fontWeight: 700, marginBottom: 4 }}>🧾 Davčna blagajna</div>
        <div style={{ fontSize: 13, color: '#888' }}>FURS certifikat, poslovni prostori in naprave</div>
      </div>
