...
export default function ApiKljuciSekcija() {
  ...
  if (loading) return <div style={{ padding: 24, textAlign: 'center', color: '#888' }}>Nalagam...</div>

  return (
    <div>
      <div>

        {/* Glava razdelka — enotna z ostalimi razdelki nastavitev (19.8.2026). */}
        <div style={{ marginBottom: 20 }}>
          <div style={{ fontSize: 15, fontWeight: 700, marginBottom: 4 }}>🔑 API vmesnik</div>
          <div style={{ fontSize: 13, color: '#888' }}>Povežite zunanje sisteme z Računko prek REST API</div>
        </div>
