...
export default function IntegracijeSekcija() {
  ...
  return (
    <div>
      <div style={{ maxWidth: 720 }}>
        ...
        {/* PRESTAVLJENO V NASTAVITVE (24.8.2026): prej svoja stran z lastno
            glavo in povezavo "← Nastavitve". Zdaj je razdelek nastavitev,
            tako kot Ekipa, API kljuci in E-mail skeniranje - glavo in
            navigacijo poskrbi stran nastavitev. */}
        <div style={{ marginBottom: 20 }}>
          <div style={{ fontSize: 18, fontWeight: 600, color: '#0D1F12', marginBottom: 4 }}>🔌 Integracije</div>
          <div style={{ fontSize: 13, color: '#888' }}>Povežite svojo spletno trgovino z Računko</div>
        </div>
